...
```{r probfunction, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r visuals, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r difference, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r descfunc, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r projected_2022_dataset, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r projected_2022_desc, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r observed_2022_desc, include=FALSE, warning=FALSE, results = 'hide'}
...
```{r table-pre, warning=FALSE, echo = FALSE}
...
The paired graphs above have the same break for each bar.

\newpage

```{r monthhomeless, warning=FALSE, message = FALSE, echo=FALSE}
...
For the crosstables, I used the original data (inlcuding all participants, answering or not answering the questions)

## Stayed at any shelter by with someone

```{r observed-crosstable1, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable2, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable3, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable4, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable5, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable6, warning=FALSE, echo=FALSE}
...
```{r observed-crosstable7, warning=FALSE, echo=FALSE}
